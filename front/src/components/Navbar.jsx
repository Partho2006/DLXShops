  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
      ...
      <ul className='sm:flex gap-5 text-sm text-gray-700 hidden'>
        ...
        >
          <p>Home</p>
          <hr className="w-0 h-[2px] bg-gray-700 border-none transition-all duration-300 group-hover:w-2/4 hidden" />
        </NavLink>
      ...
      <div className={`absolute top-0 bottom-0 overflow-hidden bg-white transition-all duration-200 ${visible ? 'w-full' : 'w-0'} `}>
        <div className="flex flex-col text-gray-600">
          ...
          <NavLink className='py-2 pl-6 border-b' to='/'>Home</NavLink>
          <NavLink className='py-2 pl-6 border-b' to='/collection'>Collection</NavLink>
          <NavLink className='py-2 pl-6 border-b' to='/about'>About</NavLink>
          <NavLink className='py-2 pl-6 border-b' to='/contact'>Contact</NavLink>
        </div>
      </div>
